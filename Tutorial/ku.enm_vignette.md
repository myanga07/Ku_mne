...
**ku.enm** is an R package designed to make the process of model calibration and final model creation easier and reproducible, but at the same time more robust.
...
Since the package is still under development functions help can be checked while performing the processess.
