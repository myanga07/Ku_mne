ku.enm.start <- function(file.name = "ku_enm_complete_process"){
  ...
  A brief tutorial for using functions of the ku.enm R package can be found in [ku.enm_vignette](). Additionally, function help can be checked to change arguments according to specific needs.
